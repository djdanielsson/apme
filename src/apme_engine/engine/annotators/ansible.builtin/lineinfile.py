"""Annotator for the ansible.builtin.lineinfile module."""
...
class LineInFileAnnotator(ModuleAnnotator):
    """Annotates lineinfile tasks with file change risk details.
    ...
    def run(self, task: TaskCall) -> ModuleAnnotatorResult:
        """Extract file change risk from lineinfile task arguments.
